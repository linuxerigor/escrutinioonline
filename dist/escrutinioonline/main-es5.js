...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _principal_principal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./principal/principal.component */
    "./src/app/principal/principal.component.ts");
    /* harmony import */


    var _criar_escrutinio_criar_escrutinio_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./criar-escrutinio/criar-escrutinio.component */
    "./src/app/criar-escrutinio/criar-escrutinio.component.ts");
    /* harmony import */


    var _escrutinio_escrutinio_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./escrutinio/escrutinio.component */
    ...
    var routes = [{
      ...
      path: 'criar',
      component: _criar_escrutinio_criar_escrutinio_component__WEBPACK_IMPORTED_MODULE_3__["CriarEscrutinioComponent"]
    }, {
      path: 'escrutinio/:id',
      component: _escrutinio_escrutinio_component__WEBPACK_IMPORTED_MODULE_4__["EscrutinioComponent"]
    }, {
      path: '',
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 19,
      vars: 4,
      consts: [[1, "cover-container", "d-flex", "w-100", "h-100", "p-3", "mx-auto", "flex-column"], [1, "masthead", "mb-auto"], [1, "inner"], [1, "masthead-brand"], [1, "nav", "nav-masthead", "justify-content-center"], ["routerLinkActive", "active", 1, "nav-link", 3, "routerLink"], ["role", "main", 1, "inner", "cover"], [1, "mastfoot", "mt-auto"], ["href", "https://carneiro.eng.br"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _block_chain_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./block-chain.service */
    ...
    var _criar_escrutinio_criar_escrutinio_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./criar-escrutinio/criar-escrutinio.component */
    "./src/app/criar-escrutinio/criar-escrutinio.component.ts");
    /* harmony import */
    ...
    var _escrutinio_escrutinio_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./escrutinio/escrutinio.component */
    "./src/app/escrutinio/escrutinio.component.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_10__["MatSnackBarModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _principal_principal_component__WEBPACK_IMPORTED_MODULE_5__["PrincipalComponent"], _criar_escrutinio_criar_escrutinio_component__WEBPACK_IMPORTED_MODULE_6__["CriarEscrutinioComponent"], _escrutinio_escrutinio_component__WEBPACK_IMPORTED_MODULE_8__["EscrutinioComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_9__["BrowserAnimationsModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_10__["MatSnackBarModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppBlockChainServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(BlockChainService, [{
        ...
        value: function createaddress() {
          ...
          return new Promise(function (resolve, reject) {
            var ret = _this.web3.eth.accounts.create('b1C98D3Fe3a9d4F37d1a153467729bE4D8E7b1C98D3Fe3a9d4F37d1a153467729bE4D8E7b1C98D3Fe3a9d4F37d1a153467729bE4D8E7b1C98D3Fe3a9d4F37d1a153467729bE4D8E7b1C98D3Fe3a9d4F37d1a153467729bE4D8E7');
        ...
        key: "votar",
        value: function votar(c, chave, proposto) {
          var _this2 = this;
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this2.web3.eth.accounts.wallet.create(1); //var myself = this.web3.eth.accounts.privateKeyToAccount(this.private_key);


            var contract = new _this2.web3.eth.Contract(JSON.parse(_this2.abi), c); //this.web3.eth.handleRevert = true;

            var contractFunction = contract.methods.voto(chave, proposto); // this.web3.eth.getTransactionCount(this.account).then(
            //   (ret) => {

            var gas = _this2.web3.utils.toHex(800000); //await transaction.estimateGas({from: PUBLIC_KEY});
            ...
            _this2.web3.eth.accounts.signTransaction(options, _this2.private_key).then(function (ret) {
              console.dir(ret); //this.resultadodavotacao = ret.transactionHash;

              try {
                _this2.web3.eth.sendSignedTransaction(ret.rawTransaction).on('receipt', function (rr) {
                  console.log(rr);
                  resolve(rr); // voto concluido
                  ...
                  console.log('then(function(receipt', receipt); //this.fechPropostos(c);
                });
              } catch (e) {
        ...
        key: "votacaoTerminada",
        value: function votacaoTerminada() {}
      }, {
        key: "fechVotos",
        value: function fechVotos(c) {
          var _this3 = this;

          var contract = new this.web3.eth.Contract(JSON.parse(this.abi), c);
          contract.methods.totalPropostos().call({
            from: this.account
          }).then(function (t) {
            var _loop = function _loop(index) {
              contract.methods.proposalVotesByPos(index).call({
                from: _this3.account
              }).then(function (result) {
                console.log('votos', result);
                _this3.candidatos[index].votos = result;
              });
            };
        ...
        key: "fechPropostos",
        value: function fechPropostos(c) {
          var _this4 = this;

          return new Promise(function (resolve, reject) {
            var contract = new _this4.web3.eth.Contract(JSON.parse(_this4.abi), c);
            contract.methods.totalPropostos().call({
              from: _this4.account
            }).then(function (t) {
              var candidatos = [];
              ...
              var _loop2 = function _loop2(index) {
                contract.methods.proposalNameByPos(index).call({
                  from: _this4.account
                }).then(function (result) {
                  var nome = _this4.web3.utils.hexToAscii(result);

                  console.log(nome);
                  candidatos.push({
                    id: index,
                    nome: nome.replace(/\0/g, '')
                  });
        ...
        key: "criarcontract",
        value: function criarcontract(form) {
          var _this5 = this;
          ...
          return new Promise(function (resolve, reject) {
            ...
            args = [args.map(function (arg) {
              return _this5.web3.utils.asciiToHex(arg);
            })];
            console.log('array', args); //deploy

            var contract = new _this5.web3.eth.Contract(JSON.parse(_this5.abi));
            var transaction = contract.deploy({
              data: '0x' + _this5.bytecode,
              arguments: args
            });

            var gas = _this5.web3.utils.toHex(800000); //await transaction.estimateGas({from: PUBLIC_KEY});
            ...
            _this5.web3.eth.accounts.signTransaction(options, _this5.private_key).then(function (signedhandle) {
              console.dir(signedhandle);

              _this5.web3.eth.sendSignedTransaction(signedhandle.rawTransaction).then(function (handle) {
                console.dir(handle);
                console.log("contract deployed at address ".concat(handle.contractAddress));
                _this5.smartcontract = handle.contractAddress;
                resolve(_this5.smartcontract);
              }, function (e) {
                console.log('sendSignedTransaction on error', e);
                reject(false);
              });
            }, function (e) {
              console.log('signTransaction on error', e);
              reject(false);
            });
          });
        } // criarcontract2() {
        ...
        key: "send",
        value: function send(transaction) {
          var _this6 = this;

          var gas = this.web3.utils.toHex(800000); //await transaction.estimateGas({from: PUBLIC_KEY});
          ...
          this.web3.eth.accounts.signTransaction(options, this.private_key).then(function (signedhandle) {
            console.dir(signedhandle);

            _this6.web3.eth.sendSignedTransaction(signedhandle.rawTransaction).then(function (handle) {
              console.dir(handle);
              console.log("contract deployed at address ".concat(handle.contractAddress));
              _this6.smartcontract = handle.contractAddress;
            }, function (e) {
              console.log('sendSignedTransaction on error', e);
            });
          }, function (e) {
    ...
    BlockChainService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BlockChainService, [{
  ...
  /***/
  function srcAppCriarEscrutinioCriarEscrutinioComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CriarEscrutinioComponent", function () {
      return CriarEscrutinioComponent;
    });
    /* harmony import */
    ...
    var _block_chain_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../block-chain.service */
    "./src/app/block-chain.service.ts");
    /* harmony import */
    ...
    function CriarEscrutinioComponent_h1_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CriarEscrutinioComponent_p_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CriarEscrutinioComponent_form_2_div_15_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CriarEscrutinioComponent_form_2_p_16_label_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CriarEscrutinioComponent_form_2_p_16_span_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "span", 23);
      }
    }

    function CriarEscrutinioComponent_form_2_p_16_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 5);
    ...
    function CriarEscrutinioComponent_form_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 6);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function CriarEscrutinioComponent_form_2_Template_form_ngSubmit_0_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "N\xFAmero de votantes");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](12, "N\xFAmero de candidatos");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function CriarEscrutinioComponent_form_2_Template_input_change_14_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r15.onChangeTickets($event);
        });
    ...
    function CriarEscrutinioComponent_div_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CriarEscrutinioComponent_p_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 5);
    ...
    function CriarEscrutinioComponent_p_5_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 5);
    ...
    var _c0 = function _c0(a1) {
      return ["/escrutinio", a1];
    };

    function CriarEscrutinioComponent_p_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 5);
    ...
    var CriarEscrutinioComponent = /*#__PURE__*/function () {
      function CriarEscrutinioComponent(formBuilder, blockchainservice) {
        _classCallCheck(this, CriarEscrutinioComponent);
      ...
      _createClass(CriarEscrutinioComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        value: function onSubmit() {
          ...
          this.blockchainservice.criarcontract(this.dynamicForm.value).then(function (smartcontract) {
            console.log('@@@@@@@: ', smartcontract);
            _this7.smartcontract = smartcontract;
    ...
    CriarEscrutinioComponent.ɵfac = function CriarEscrutinioComponent_Factory(t) {
      return new (t || CriarEscrutinioComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_block_chain_service__WEBPACK_IMPORTED_MODULE_2__["BlockChainService"]));
    };

    CriarEscrutinioComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: CriarEscrutinioComponent,
      selectors: [["app-criar-escrutinio"]],
      decls: 7,
      vars: 7,
      consts: [["class", "cover-heading", 4, "ngIf"], ["class", "lead", 4, "ngIf"], [3, "formGroup", "ngSubmit", 4, "ngIf"], ["class", "alert alert-danger", "role", "alert", 4, "ngIf"], [1, "cover-heading"], [1, "lead"], [3, "formGroup", "ngSubmit"], [1, "align-items-center"], [1, "col-auto"], [1, "form-group", "row"], [1, "col-8"], ["for", "number", 1, "col-form-label"], [1, "col-4"], ["type", "number", "id", "number", "min", "0", "formControlName", "numbervotantes", 1, "form-control"], ["type", "number", "id", "number", "min", "0", "formControlName", "numberOfTickets", 1, "form-control", 3, "change"], ["class", "", 4, "ngFor", "ngForOf"], [1, ""], [1, "form-row", "align-items-center", 3, "formGroup"], [1, "form-group", "col-12"], ["type", "text", "formControlName", "name", "maxlength", "30", 1, "form-control"], [4, "ngIf"], ["type", "submit", 1, "btn", "btn-lg", "btn-secondary", 3, "disabled"], ["class", "spinner-border spinner-border-sm", "role", "status", "aria-hidden", "true", 4, "ngIf"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm"], ["role", "alert", 1, "alert", "alert-danger"], ["href", "#", 1, "btn", "btn-lg", "btn-secondary", 3, "routerLink"]],
      template: function CriarEscrutinioComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CriarEscrutinioComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _block_chain_service__WEBPACK_IMPORTED_MODULE_2__["BlockChainService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppEscrutinioEscrutinioComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EscrutinioComponent", function () {
      return EscrutinioComponent;
    });
    /* harmony import */
    ...
    var _block_chain_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../block-chain.service */
    "./src/app/block-chain.service.ts");
    /* harmony import */
    ...
    function EscrutinioComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Para votar, voc\xEA precisa criar uma identifica\xE7\xE3o na Blockchain");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EscrutinioComponent_div_4_Template_button_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.criarid();
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Gerar minha identifica\xE7\xE3o");
    ...
    function EscrutinioComponent_div_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Guardar sua chave em seguran\xE7a e sigilo. Somente com ela \xE9 poss\xEDvel auditar o seu voto.");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Minha chave de identifica\xE7\xE3o");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EscrutinioComponent_div_5_Template_input_click_9_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r5.sharebyclipboard($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EscrutinioComponent_div_5_Template_input_ngModelChange_12_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.confirm = $event;
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EscrutinioComponent_div_5_Template_button_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r8.setchavesalva();
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, "Prosseguir com a vota\xE7\xE3o");
    ...
    function EscrutinioComponent_div_6_ul_10_li_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EscrutinioComponent_div_6_ul_10_li_1_Template_button_click_4_listener() {
          ...
          return ctx_r15.confirmvoto(item_r14);
        });
    ...
    function EscrutinioComponent_div_6_ul_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EscrutinioComponent_div_6_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function EscrutinioComponent_div_6_div_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 28);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Voto conclu\xEDdo com sucesso ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
      }
    }

    function EscrutinioComponent_div_6_div_13_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 25);
    ...
    function EscrutinioComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var EscrutinioComponent = /*#__PURE__*/function () {
      function EscrutinioComponent(route, snackBar, blockchainservice) {
        _classCallCheck(this, EscrutinioComponent);
      ...
      _createClass(EscrutinioComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        key: "setchavesalva",
        value: function setchavesalva() {
          var _this8 = this;

          this.chavesalva = true;
          this.blockchainservice.fechPropostos(this.escrutinioid).then(function (ret) {
            _this8.propostos = ret;
          }, function () {
            console.log('error');
          });
        }
        ...
        key: "criarid",
        value: function criarid() {
          var _this9 = this;

          this.blockchainservice.createaddress().then(function (ret) {
            _this9.minhachave = ret;
          }, function () {
            console.log('error');
          });
        }
        ...
        key: "confirmvoto",
        value: function confirmvoto(item) {
          var _this10 = this;

          if (confirm('Você confirma o seu foto para: ' + item.nome)) {
            this.submitted = true;
            this.blockchainservice.votar(this.escrutinioid, this.minhachave, item.id).then(function (ret) {
              console.log(ret);
              _this10.submitted = false;
              _this10.vototerminado = true;
            }, function () {
              console.log('error');
              _this10.submitted = false;
            });
        ...
        key: "sharebyclipboard",
        value: function sharebyclipboard(val) {
          val.target.select();
    ...
    EscrutinioComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["CheckboxControlValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EscrutinioComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          ...
          type: _block_chain_service__WEBPACK_IMPORTED_MODULE_3__["BlockChainService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppPrincipalPrincipalComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PrincipalComponent = /*#__PURE__*/function () {
      ...
      _createClass(PrincipalComponent, [{
        ...
        key: "escrutinioenter",
        value: function escrutinioenter(e) {
          if (this.escrutinioid.search(/^0x[\S]{40}/) !== -1) {
    ...
    PrincipalComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 3,
      consts: [[1, "cover-heading"], [1, "lead"], ["href", "#", 1, "btn", "btn-lg", "btn-secondary", 3, "routerLink"], [1, "cover-heading", "mt-5"], [1, "lead", "mt-5"], [1, "text-small"], ["type", "text", "placeholder", "ID: .......", 1, "form-control", 3, "ngModel", "ngModelChange"]],
      template: function PrincipalComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](3, "Vota\xE7\xE3o online, secreta e audit\xE1vel");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](11, "Digite o n\xFAmero do escrutinio");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](12, "input", 6);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PrincipalComponent_Template_input_ngModelChange_12_listener($event) {
            return ctx.escrutinioid = $event;
          })("ngModelChange", function PrincipalComponent_Template_input_ngModelChange_12_listener($event) {
            return ctx.escrutinioenter($event);
          });
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterLinkWithHref"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgModel"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/igormarques/Documents/IGOR/Projetos/escrutinioonline/src/main.ts */
    "./src/main.ts");
    /***/
  },
